...
URL Source: https://www.ccet.ac.in/library.php
...
*   [About Us](https://www.ccet.ac.in/library.php#)
...
*   [Admissions](https://www.ccet.ac.in/library.php#)
...
*   [Academics](https://www.ccet.ac.in/library.php#)
...
*   [Student Section](https://www.ccet.ac.in/library.php#)
...
*   [NIRF](https://www.ccet.ac.in/library.php#)
    
    *   ### NIRF REPORTS
        
    *   [NIRF Report 2023](https://www.ccet.ac.in/pdf/NIRFReport2023.pdf)
    
*   [Notices](https://www.ccet.ac.in/library.php#)
...
*   [About](https://www.ccet.ac.in/library.php#)
...
*   [Administration](https://www.ccet.ac.in/library.php#)
...
*   [Life @ CCET](https://www.ccet.ac.in/library.php#)
...
*   [JAC](https://www.ccet.ac.in/library.php#)
...
*   [Programmes](https://www.ccet.ac.in/library.php#)
...
*   [Criteria](https://www.ccet.ac.in/library.php#)
...
*   [Academic Departments](https://www.ccet.ac.in/library.php#)
...
*   [Welfare](https://www.ccet.ac.in/library.php#)
...
*   [Events](https://www.ccet.ac.in/library.php#)
...
*   [NIRF Reports](https://www.ccet.ac.in/library.php#)
...
*   [E-News Letter](https://www.ccet.ac.in/library.php#)
...
*   [Info Reg. B.E. Exams 2021](https://www.ccet.ac.in/library.php#)
...
*   [Helpdesk](https://www.ccet.ac.in/library.php#)
...
*   [Visit Us](https://www.ccet.ac.in/library.php#visitus)

CCET Central Library
====================

Abode of knowledge, experience and learning
...
[Previous](https://www.ccet.ac.in/library.php#carouselExampleIndicators) [Next](https://www.ccet.ac.in/library.php#carouselExampleIndicators)

### About Library

To support the academic requirements of the faculty & students, the college has a well stocked library with a collection of about 12000 volumes in Science & Technology, catering to the needs of about 900 members (Both faculty & students) imparting/pursuing studies in four different branches of Engg.

The library is continuously in the process to acquire text books & reference books, to keep its reader abreast with the latest information. The library of the institute aims to facilitate academic & research activities of the faculty & students by providing timely information & resource through cost effective means. The college library is organized into various sections, which are managed by professionally qualified staff. The library is also an institutional member of British Library. British Library also provides information for studying in Britain and about various British examinations like IELTS, BEC, PLAB, YLE etc.

Show More [Library Website](https://ccetchdlibrary.weebly.com/)

[![Image 13](http://placehold.it/700x400)](https://www.ccet.ac.in/library.php#)

#### [Library Notices and Circulars](https://www.ccet.ac.in/library.php#)
...
![Image 14](http://placehold.it/1200x400)
...
NDL India is designed to hold content of any language and provides interface support for leading Indian languages (currently Hindi and Bengali). It is being arranged to provide support for all academic levels including researchers and life-long learners, all disciplines, all popular form of access devices and differently-abled learners. It is being developed to help students to prepare for entrance and competitive examination, to enable people to learn and prepare from best practices from all over the world and to facilitate researchers to perform inter-linked exploration from multiple sources. The pilot project is devising a framework that is being scaled up with respect to content volume and diversity to serve all levels and disciplines of learners. It is being developed at IIT Kharagpur.

Show More [National Digital Library](https://www.ccet.ac.in/library.php#)

Chandigarh College of Engineering and Technology | Degree Wing
===============
  [](https://www.ccet.ac.in/library.php#)
